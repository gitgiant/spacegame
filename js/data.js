...
G.WEAPONS = {
  ...
  missile_launcher: {
    ...
    color:'#ff8800', width:3, pierce:false, splash:120, tracking:true, ammo:'missiles', ammoPerShot:1,
    price:4000, mass:10, rarity:'u', desc:'Long-range seeking missile. Tracks targets, massive splash damage.',
  ...
  missile_turret: {
    ...
    color:'#ff8800', width:3, pierce:false, splash:110, tracking:true, turret:true, ammo:'missiles', ammoPerShot:1,
    price:7000, mass:14, rarity:'r', desc:'360° missile turret. Auto-locks nearest enemy, fires guided missiles.',
...
G.SHIPS = {
  ...
  shuttle: {
    ...
    slots:10,
    startModules:['core_shuttle',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','small_cargo','light_shield'],
    startWeapons:['turret'],
  ...
  earth_shuttle: {
    ...
    baseThrust:14000, baseTurn:0, baseCargoSpace:0,
    slots:11,
    startModules:['core_earth_shuttle',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','small_cargo','small_cargo','basic_sensors'],
    startWeapons:['turret'],
  ...
  rebel_runner: {
    ...
    slots:10,
    startModules:['core_rebel_runner',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},'reactor','jump_drive','small_cargo','fuel_tank'],
    startWeapons:['turret'],
    startCells:[31,40,57,59,58,41,39,48,50,22],
  ...
  pirate_skiff: {
    ...
    slots:9,
    startModules:['core_pirate_skiff',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},'reactor','jump_drive','small_cargo'],
    startWeapons:['turret'],
  ...
  alien_pod: {
    ...
    slots:10,
    startModules:['core_alien_pod',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},'reactor','jump_drive','small_cargo'],
    startWeapons:['turret'],
    startCells:[31,40,57,59,58,41,39,48,22],
  ...
  miner_ship: {
    ...
    slots:13,
    startModules:['core_miner_ship',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','medium_cargo','medium_cargo'],
  ...
  earth_miner: {
    ...
    slots:14,
    startModules:['core_earth_miner',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','medium_cargo','medium_cargo','basic_sensors'],
  ...
  rebel_miner: {
    ...
    slots:13,
    startModules:['core_rebel_miner',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','medium_cargo','medium_cargo'],
  ...
  container_ship: {
    ...
    slots:15,
    startModules:['core_container_ship',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','large_cargo','large_cargo','large_cargo'],
  ...
  earth_hauler: {
    ...
    slots:17,
    startModules:['core_earth_hauler',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','large_cargo','large_cargo','large_cargo','hull_armor'],
    startWeapons:['autocannon','turret','turret','turret','turret'],
  ...
  rebel_hauler: {
    ...
    slots:16,
    startModules:['core_rebel_hauler',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','medium_cargo','medium_cargo','medium_cargo','fuel_tank'],
  ...
  tanker_ship: {
    ...
    slots:14,
    startModules:['core_tanker_ship',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','fuel_tank','fuel_tank','large_cargo'],
    startWeapons:['autocannon','turret','turret','turret','turret'],
  ...
  earth_tanker: {
    ...
    baseThrust:6500, baseTurn:0, baseCargoSpace:0,
    slots:15,
    startModules:['core_earth_tanker',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','fuel_tank','fuel_tank','fuel_tank','hull_armor'],
    startWeapons:['autocannon','turret','turret','turret','turret'],
  ...
  fighter: {
    ...
    baseThrust:22000, baseTurn:0, baseCargoSpace:0,
    slots:14,
    startModules:['core_fighter',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','jump_drive'],
  ...
  earth_fighter: {
    ...
    slots:15,
    startModules:['core_earth_fighter',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','light_shield','jump_drive'],
  ...
  rebel_fighter: {
    ...
    slots:13,
    startModules:['core_rebel_fighter',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','jump_drive'],
  ...
  alien_fighter: {
    ...
    slots:13,
    startModules:['core_alien_fighter',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','light_shield','jump_drive'],
  ...
  cruise_liner: {
    ...
    slots:21,
    startModules:['core_cruise_liner',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','large_cargo','officer_block','officer_block'],
    startWeapons:['autocannon','turret','turret','turret','turret'],
  ...
  earth_liner: {
    ...
    baseThrust:6000, baseTurn:0, baseCargoSpace:0,
    slots:23,
    startModules:['core_earth_liner',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},'reactor','jump_drive','large_cargo','officer_block','officer_block','medium_shield'],
    startWeapons:['autocannon','turret','turret','turret','turret'],
  ...
  corvette: {
    ...
    slots:17,
    startModules:['core_corvette',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','light_shield','jump_drive','medium_cargo'],
  ...
  earth_corvette: {
    ...
    baseThrust:22000, baseTurn:0, baseCargoSpace:0,
    slots:18,
    startModules:['core_earth_corvette',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','light_shield','jump_drive'],
  ...
  rebel_corvette: {
    ...
    baseThrust:23000, baseTurn:0, baseCargoSpace:0,
    slots:17,
    startModules:['core_rebel_corvette',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','light_shield','jump_drive'],
  ...
  pirate_corvette: {
    ...
    slots:15,
    startModules:['core_pirate_corvette',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','jump_drive'],
    startWeapons:['laser_cannon','autocannon','autocannon','missile_launcher','turret','turret','turret','turret'],
  ...
  frigate: {
    ...
    slots:19,
    startModules:['core_frigate',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','medium_shield','jump_drive','medium_cargo'],
  ...
  earth_patrol: {
    ...
    slots:20,
    startModules:['core_earth_patrol',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','medium_shield','jump_drive'],
  ...
  rebel_frigate: {
    ...
    baseThrust:17000, baseTurn:0, baseCargoSpace:0,
    slots:19,
    startModules:['core_rebel_frigate',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','medium_shield','jump_drive'],
    startWeapons:['heavy_laser','autocannon','autocannon','missile_launcher','turret','turret','turret','turret','turret'],
    startCells:[31,40,56,60,58,51,47,41,38,39,20,22,24,13],
  ...
  pirate_raider: {
    ...
    baseThrust:18000, baseTurn:0, baseCargoSpace:0,
    slots:18,
    startModules:['core_pirate_raider',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','light_shield','jump_drive','medium_cargo'],
  ...
  alien_scout: {
    ...
    slots:18,
    startModules:['core_alien_scout',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','light_shield','jump_drive'],
  ...
  bomber: {
    ...
    baseThrust:14000, baseTurn:0, baseCargoSpace:0,
    slots:20,
    startModules:['core_bomber',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},{id:'thruster',rot:1},{id:'thruster',rot:3},'reactor','medium_shield','jump_drive','crew_quarters','hull_armor'],
  ...
  earth_bomber: {
    ...
    slots:21,
    startModules:['core_earth_bomber',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},{id:'thruster',rot:1},{id:'thruster',rot:3},'reactor','medium_shield','jump_drive','heavy_armor'],
  ...
  rebel_bomber: {
    ...
    slots:20,
    startModules:['core_rebel_bomber',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},{id:'thruster',rot:1},{id:'thruster',rot:3},'reactor','medium_shield','jump_drive'],
  ...
  pirate_marauder: {
    ...
    slots:19,
    startModules:['core_pirate_marauder',{id:'thruster',rot:0},{id:'thruster',rot:0},{id:'thruster',rot:2},{id:'thruster',rot:1},{id:'thruster',rot:3},'reactor','light_shield','jump_drive','medium_cargo'],
  ...
  destroyer: {
    ...
    slots:22,
    startModules:['core_destroyer',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','medium_shield','medium_shield','jump_drive','hull_armor'],
    startWeapons:['heavy_laser','heavy_laser','autocannon','missile_launcher','turret','turret','turret','turret','turret','turret'],
  ...
  earth_destroyer: {
    ...
    baseThrust:16000, baseTurn:0, baseCargoSpace:0,
    slots:23,
    startModules:['core_earth_destroyer',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','medium_shield','medium_shield','jump_drive','military_sensors'],
    startWeapons:['heavy_laser','heavy_laser','autocannon','missile_launcher','turret','turret','turret','turret','turret','turret'],
  ...
  rebel_destroyer: {
    ...
    slots:22,
    startModules:['core_rebel_destroyer',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','medium_shield','medium_shield','jump_drive'],
  ...
  pirate_destroyer: {
    ...
    baseThrust:14000, baseTurn:0, baseCargoSpace:0,
    slots:21,
    startModules:['core_pirate_destroyer',{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:0},{id:'thruster_imp',rot:2},{id:'thruster_imp',rot:1},{id:'thruster_imp',rot:3},'reactor','medium_shield','jump_drive','medium_cargo'],
    startWeapons:['heavy_laser','autocannon','autocannon','missile_launcher','turret','turret','turret','turret','turret','turret'],
  ...
  cruiser: {
    ...
    slots:26,
    startModules:['core_cruiser',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},{id:'thruster_mil',rot:1},{id:'thruster_mil',rot:3},'military_reactor','heavy_shield','jump_drive','heavy_armor'],
  ...
  earth_cruiser: {
    ...
    baseThrust:9500, baseTurn:0, baseCargoSpace:0,
    slots:28,
    startModules:['core_earth_cruiser',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},{id:'thruster_mil',rot:1},{id:'thruster_mil',rot:3},'military_reactor','heavy_shield','heavy_shield','jump_drive','heavy_armor'],
    startWeapons:['heavy_laser','heavy_laser','railgun','missile_launcher','turret','turret','turret','turret','turret','turret','turret','turret'],
  ...
  rebel_cruiser: {
    ...
    slots:27,
    startModules:['core_rebel_cruiser',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},{id:'thruster_mil',rot:1},{id:'thruster_mil',rot:3},'military_reactor','heavy_shield','jump_drive','heavy_armor'],
  ...
  pirate_battleship: {
    ...
    baseThrust:8000, baseTurn:0, baseCargoSpace:0,
    slots:25,
    startModules:['core_pirate_battleship',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},{id:'thruster_mil',rot:1},{id:'thruster_mil',rot:3},'reactor','heavy_shield','jump_drive','heavy_armor'],
  ...
  alien_warship: {
    ...
    slots:28,
    startModules:['core_alien_warship',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},{id:'thruster_mil',rot:1},{id:'thruster_mil',rot:3},'military_reactor','heavy_shield','heavy_shield','jump_drive'],
  ...
  carrier: {
    ...
    baseThrust:6000, baseTurn:0, baseCargoSpace:0,
    slots:30,
    startModules:['core_carrier',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},'military_reactor','heavy_shield','jump_drive','officer_block','officer_block','heavy_armor','heavy_armor'],
  ...
  earth_carrier: {
    ...
    slots:32,
    startModules:['core_earth_carrier',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},'military_reactor','heavy_shield','heavy_shield','jump_drive','officer_block','officer_block','military_sensors','heavy_armor','heavy_armor'],
  ...
  rebel_carrier: {
    ...
    baseThrust:6000, baseTurn:0, baseCargoSpace:0,
    slots:31,
    startModules:['core_rebel_carrier',{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:0},{id:'thruster_mil',rot:2},'military_reactor','heavy_shield','jump_drive','officer_block','officer_block','heavy_armor'],
    startWeapons:['railgun','railgun','missile_launcher','turret','turret','turret','turret','turret','turret','turret','turret','turret','turret'],
