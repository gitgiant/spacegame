...
G.WEAPONS = {
  ...
  mining_laser_wpn: {
    ...
    damage:18, range:280, energyCost:1, fireRate:20, projSpeed:1100,
...
G.SHIPS = {
  ...
  shuttle: {
    ...
    price:0,
    baseMass:80, baseHull:100, baseEnergy:120, baseFuel:80,
    baseThrust:14000, baseTurn:2.0, baseCargoSpace:8,
    slots:9,
    startModules:['basic_engine','jump_drive','small_cargo','light_shield'],
    startWeapons:['laser_cannon'],
    shape:'shuttle', color:'#8899bb', size:1.0,
    expansionLimit:3,
    stats:'HULL:50  SHIELDS:80  CARGO:8',
  },
  earth_shuttle: {
  ...
  miner_ship: {
    ...
    price:7000,
    baseMass:170, baseHull:280, baseEnergy:130, baseFuel:80,
    baseThrust:8000, baseTurn:1.0, baseCargoSpace:20,
    slots:12,
    startModules:['basic_engine','jump_drive','medium_cargo','medium_cargo','mining_laser'],
    startWeapons:['laser_cannon'],
    shape:'miner', color:'#aa9966', size:1.4,
    expansionLimit:4,
    stats:'HULL:140  CARGO:20  MINER',
  },
  earth_miner: {
  ...
  fighter: {
    ...
    price:14000,
    baseMass:90, baseHull:100, baseEnergy:150, baseFuel:85,
    baseThrust:22000, baseTurn:2.6, baseCargoSpace:2,
    slots:12,
    ...
    expansionLimit:3,
    stats:'HULL:50  CARGO:2  MISSILES  FAST',
  },
  earth_fighter: {
    ...
    price:20000,
    baseMass:130, baseHull:280, baseEnergy:170, baseFuel:90,
    baseThrust:21000, baseTurn:2.1, baseCargoSpace:4,
    slots:13,
  ...
  rebel_fighter: {
    ...
    price:17000,
    baseMass:110, baseHull:220, baseEnergy:155, baseFuel:88,
    baseThrust:23000, baseTurn:2.6, baseCargoSpace:3,
    slots:11,
    startModules:['improved_engine','jump_drive'],
    startWeapons:['laser_cannon','autocannon','autocannon'],
    shape:'fighter', color:'#ff6600', size:0.95,
    expansionLimit:3,
    stats:'HULL:110  FASTEST  GUNS:3',
  },
  pirate_fighter: {
    ...
    price:13000,
    baseMass:100, baseHull:200, baseEnergy:145, baseFuel:80,
    baseThrust:22000, baseTurn:2.7, baseCargoSpace:3,
    slots:10,
    startModules:['improved_engine','jump_drive'],
    startWeapons:['autocannon','autocannon','autocannon'],
    shape:'fighter', color:'#cc3322', size:0.9,
    expansionLimit:2,
    stats:'HULL:100  GUNS:3  SCRAPPY',
  },
  alien_fighter: {
    ...
    price:55000,
    baseMass:90, baseHull:260, baseEnergy:280, baseFuel:110,
    baseThrust:28000, baseTurn:3.2, baseCargoSpace:2,
    slots:11,
    startModules:['improved_engine','light_shield','jump_drive'],
    startWeapons:['laser_cannon','laser_cannon'],
    shape:'fighter', color:'#00ff88', size:0.9,
    expansionLimit:3,
    stats:'HULL:130  ALIEN  FASTEST',
  },
  ...
  corvette: {
    ...
    startWeapons:['laser_cannon','autocannon','missile_launcher'],
  ...
  earth_corvette: {
    ...
    slots:16,
    startModules:['improved_engine','light_shield','jump_drive'],
    startWeapons:['laser_cannon','laser_cannon','autocannon','missile_launcher'],
  ...
  rebel_corvette: {
    ...
    slots:15,
    startModules:['improved_engine','light_shield','jump_drive'],
    startWeapons:['laser_cannon','autocannon','autocannon','missile_launcher'],
  ...
  earth_patrol: {
    ...
    startWeapons:['heavy_laser','laser_cannon','autocannon','missile_launcher'],
  ...
  pirate_raider: {
    ...
    slots:16,
    startModules:['improved_engine','light_shield','jump_drive','medium_cargo'],
    startWeapons:['autocannon','autocannon','autocannon','missile_launcher'],
  ...
  alien_scout: {
    ...
    slots:16,
    startModules:['improved_engine','light_shield','jump_drive'],
    startWeapons:['laser_cannon','laser_cannon','missile_launcher'],
  ...
  bomber: {
    ...
    startWeapons:['heavy_laser','autocannon','autocannon','autocannon','missile_launcher'],
  ...
  earth_bomber: {
    ...
    startWeapons:['heavy_laser','heavy_laser','autocannon','missile_launcher'],
  ...
  pirate_marauder: {
    ...
    startWeapons:['autocannon','autocannon','autocannon','autocannon','missile_launcher'],
  ...
  destroyer: {
    ...
    startWeapons:['heavy_laser','heavy_laser','autocannon','auto_turret','missile_launcher'],
  ...
  rebel_destroyer: {
    ...
    slots:20,
    startModules:['improved_engine','medium_shield','medium_shield','jump_drive'],
    startWeapons:['heavy_laser','heavy_laser','railgun','autocannon','missile_launcher'],
  ...
  pirate_destroyer: {
    ...
    startWeapons:['heavy_laser','autocannon','autocannon','auto_turret','missile_launcher'],
  ...
  cruiser: {
    ...
    startWeapons:['heavy_laser','heavy_laser','railgun','auto_turret','missile_launcher'],
  ...
  earth_cruiser: {
    ...
    startWeapons:['heavy_laser','heavy_laser','railgun','auto_turret','auto_turret','missile_launcher'],
  ...
  rebel_cruiser: {
    ...
    slots:25,
    startModules:['military_engine','heavy_shield','jump_drive','heavy_armor','military_reactor'],
    startWeapons:['heavy_laser','railgun','railgun','auto_turret','missile_launcher'],
  ...
  alien_warship: {
    ...
    startWeapons:['heavy_laser','heavy_laser','laser_cannon','auto_turret','missile_launcher'],
  ...
  carrier: {
    ...
    startWeapons:['railgun','auto_turret','auto_turret','missile_launcher'],
  ...
  earth_carrier: {
    ...
    startWeapons:['railgun','railgun','auto_turret','auto_turret','missile_launcher'],
